pub const packages = struct {
    ...
    pub const @"SpacialGrid-0.0.0-JQsE6JM4AQBJ-RSTz4cNdv2AJEH4h9hK5FZu0Pqpa5_-" = struct {
        pub const build_root = "/home/dogmaticpolack/Documents/TestSpacialGrid/zig-pkg/SpacialGrid-0.0.0-JQsE6JM4AQBJ-RSTz4cNdv2AJEH4h9hK5FZu0Pqpa5_-";
        pub const build_zig = @import("SpacialGrid-0.0.0-JQsE6JM4AQBJ-RSTz4cNdv2AJEH4h9hK5FZu0Pqpa5_-");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
        };
    };
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "SpacialGrid", "SpacialGrid-0.0.0-JQsE6JM4AQBJ-RSTz4cNdv2AJEH4h9hK5FZu0Pqpa5_-" },
};
