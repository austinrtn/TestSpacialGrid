pub const packages = struct {
    ...
    pub const @"SpacialGrid-0.0.0-JQsE6CA0AQCtWkpIrXJ52VA07-Phln4LT5b_Ve11fxZe" = struct {
        pub const build_root = "/home/dogmaticpolack/Documents/TestSpacialGrid/zig-pkg/SpacialGrid-0.0.0-JQsE6CA0AQCtWkpIrXJ52VA07-Phln4LT5b_Ve11fxZe";
        pub const build_zig = @import("SpacialGrid-0.0.0-JQsE6CA0AQCtWkpIrXJ52VA07-Phln4LT5b_Ve11fxZe");
        pub const deps: []const struct { []const u8, []const u8 } = &.{
        };
    };
...
pub const root_deps: []const struct { []const u8, []const u8 } = &.{
    ...
    .{ "SpacialGrid", "SpacialGrid-0.0.0-JQsE6CA0AQCtWkpIrXJ52VA07-Phln4LT5b_Ve11fxZe" },
};
